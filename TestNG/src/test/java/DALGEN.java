 ...
 * 
 * @History <li>Author: bohr.qiu</li> <li>Date: 2013-4-22</li> <li>Version: 1.0</li>
 * <li>Content: create</li>
 * 
 */
public class DALGEN {
	
	private static final Logger logger = LoggerFactory.getLogger("wiley");
	String propertiesLocation = "dalgen/commonproducts_generatorConfig.xml";
	...
	private void input() {
		...
		if ("Y".equalsIgnoreCase(line)) {
			...
			logger.info("请输入要生成代码的表(请以逗号隔开，回车生成配置文件中所有的表):");
			line = s.nextLine();
			if (!StringUtils.isBlank(line)) {
